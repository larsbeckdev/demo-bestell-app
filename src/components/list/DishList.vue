...
<template>
  <div class="flex flex-col gap-8">
    ...
    >
      <div
        class="flex items-center gap-3 bg-primary text-white text-2xl px-4 py-2 rounded-full mb-2"
      >
        <div
          class="bg-primary rounded-full p-2 w-16 h-16 flex items-center justify-center"
        >
