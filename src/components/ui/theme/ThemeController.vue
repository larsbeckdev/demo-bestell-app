...
import { initTheme, applyTheme, setStoredTheme, getStoredTheme } from '@/utils/theme.js'
...
<template>
  <div class="dropdown dropdown-end">
    ...
    <div
      tabindex="0"
      class="dropdown-content z-[60] mt-2 w-64 rounded-box border border-base-200 bg-base-100 shadow-xl"
    >
